        ...
        <div className="tw-flex tw-justify-center tw-mt-7">
           <form onSubmit={submitHandler}>
            <div className="tw-gap-y-2 tw-mb-3">
                ...
                <input className="tw-bg-slate-500 tw-text-white tw-p-3 tw-rounded-lg"  type={'text'} placeholder={'username'} value={data.username} onChange={(e)=>{setData({...data,username:e.target.value})}} />
            </div>
            <div className="tw-gap-y-2 tw-mb-3">
            ...
            <div className="tw-gap-y-2 tw-mb-3">
                ...
                <input  className="tw-bg-slate-500 tw-text-white tw-p-3 tw-rounded-lg"   type={'password'} placeholder={'ConformPassword'} value={data.conformPassword} onChange={(e)=>{setData({...data,conformPassword:e.target.value})}} />
            </div>
